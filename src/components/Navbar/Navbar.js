                ...
                isSearchReceived ?
                  <div>
                    ...
                    <div className="d-flex gap-2 align-items-center">
                      <Skeleton animation="wave" className="rounded" variant="rectangle" width={80} height={80} />
                  ...
                  {cookies.access_token ?
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <Dialog
                          sx={{ color: '#fff', zIndex: (theme) => theme.zIndex.drawer + 1, backdropFilter: backdropLogin && " blur(10px)" }}
                          open={backdropLogin}
